...

{
    ...
    "assets": {
        "point_of_sale._assets_pos": [
            "pos_discount_all/static/src/js/models.esm.js",
            "pos_discount_all/static/src/js/order_widget.esm.js",
        ],
        "web.assets_backend": [
            "pos_discount_all/static/src/tests/tours/PosDiscountAllTour.tour.js",
        ],
    },
    "demo": [
